...
import { 
    ...
    Book, Users, Award, Settings, ChevronDown
  } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-64 py-2 px-4 pr-10 bg-gray-800 border border-cyan-400/20 
            ...
            <div className="col-span-3">
              <div className="bg-gray-800 rounded-lg p-6 border border-cyan-400/20">
                <div className="text-center mb-6">
                  <div className="w-32 h-32 mx-auto mb-4 rounded-full overflow-hidden border-4 border-cyan-400/20">
                    <img
                      src="user.jpeg"
                      alt="Profile"
                ...
                <div className="space-y-4">
                  <button className="w-full py-2 px-4 bg-cyan-400 text-gray-900 rounded-lg 
                                  hover:bg-cyan-300 transition-colors duration-300">
                    Edit Profile
                  </button>
                  <button className="w-full py-2 px-4 border border-cyan-400/50 text-cyan-400 
                                  rounded-lg hover:bg-cyan-400/10 transition-colors duration-300">
                    View Public Profile
                  </button>
                </div>
            ...
            <div className="col-span-9 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  ...
                  <button key={i} className="p-6 bg-gray-800 rounded-lg border border-cyan-400/20 
